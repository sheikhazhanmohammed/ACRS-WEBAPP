...
from wordList import hindiWordsList, tamilWordsList, englishWordsList, wordGenerator, G2R
...
@app.route('/englishWordsList')
def englishWords():
    return render_template('englishWordList.html', englishWords=englishWordsList, title='English Word List')
